                ...
                <div class="lg:w-1/2   ">
                    <div class="w-3/5  mt-12 ml-40  ">
                        <div class=" border rounded-lg border-regal-blue border-opacity-20 shadow-xl">
                            ...
                            <div class=" pt-10 rounded-t-lg bg-regal-cyan">
                            </div>
                            <div class="flex justify-between p-4 mt-2">
                                <div class="ml-3 ">

                                    <h4 class="text-xl text-regal-teal font-semibold mb-2">Dr. John doe</h4>
                            ...
                            <div class="w-1/2 ml-7 mb-7 mt-3 border-t border-regal-blue">
                            ...
                            <div class="flex justify-between ">
                                <div class="p-2 ml-5">
                                    ...
                                    <h1 class="flex justify-start text-regal-teal mb-1"><span> Email </span> <span class="ml-20 pl-1 pr-2">:</span>  <span>jondoe@gmail.com</span></h1>
                                    <h1 class="flex justify-start text-regal-teal mb-1"><span> Phone Number </span> <span class="ml-4 pr-2">:</span> <span>01986321547</span></h1>
                                    <h1 class="flex justify-start text-regal-teal mb-1"><span> Address </span> <span class="ml-16 pr-2">:</span> <span>2/3 dhanmondi</span></h1>
                                </div>
                                <div class="mt-5">
                                ...
                                <svg width="120" height="100" viewBox="0 0 188 145" fill="none"
                                    ...
                                    <defs>
                                        <linearGradient id="paint0_linear_623:1039" x1="130.5" y1="89" x2="82.5" y2="31"
