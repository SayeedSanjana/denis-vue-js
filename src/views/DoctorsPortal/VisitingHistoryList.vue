<template>
  <div>
    <!-- if change components is false then it will show only the visiting list -->
    <div v-if="!changecomponents">
      <p class="text-left font-semibold text-regal-teal mx-12 mt-6 ">Visiting History</p>

      <!-- If there exists visiting history -->
       ...
       <!-- visiting list starts here -->
        <div v-for="i in this.AppointmentList" :key="i">
          <div class="lg:flex shadow-md border border-regal-blue border-opacity-30 justify-center mx-12 my-6 hover:bg-opacity-20 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:shadow-sm " v-if="!changecomponents">
            ...
            <div class="bg-regal-visGreen rounded-br-4xl py-4  h-full shadow-inner lg:w-2/5 ">
        ...
        <!-- visiting list ends here -->
      </div>

      <!-- If there is no visiting list this porion of the div will be shown-->
      <div v-else class="flex-row mx-12">
        ...
        <div class=" flex items-center justify-center  ">
          ...
          <div class="bg-regal-teal px-6 py-4  my-4 rounded-md text-lg mx-auto flex items-center  w-full ">
            ...
            <div>
              <p class="font-bold text-white">No Past Visiting History</p>
            </div>
          </div>
          <!-- End Alert Info -->
