<template>
  <div>
    <!-- if change components is false then it will show only the list of treatments -->
    <div v-if="!changecomponents">
      <p class="text-left font-semibold text-regal-teal mx-12 mt-6 ">Treatment History</p>

      <!-- If there exists treatment -->
       ...
       <!-- Treatment list starts here -->
        <div v-for="i in 4" :key="i">
          <div class="lg:flex shadow-md border border-regal-blue border-opacity-30 justify-center mx-12 my-6 hover:bg-opacity-20 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:shadow-sm " v-if="!changecomponents">
            ...
            <div class="bg-regal-treatGreen  rounded-br-4xl py-4  h-full shadow-inner lg:w-2/5 ">
            ...
            <!-- Treatment name starts here -->
              <div class="lg:w-4/5 ">
                <div class="flex flex-row lg:justify-start mb-3 ">
                  <p class="text-regal-teal text-sm font-semibold">Treatment Name</p>
                </div>
              ...
              <!-- Treatment name ends here -->
              
              <!-- Details button starts here -->
              <div  class="flex justify-end items-center cursor-pointer lg:w-1/5">
        ...
        <!-- Treatment list ends here -->
      </div>

      <!-- If there is no treatment this porion of the div will be shown-->
      <div v-else class="flex-row mx-12">
        ...
        <div class=" flex items-center justify-center  ">
          ...
          <div class="bg-regal-teal px-6 py-4  my-4 rounded-md text-lg mx-auto flex items-center  w-full ">
            ...
            <div>
              <p class="font-bold text-white">No Past Treatment History</p>
            </div>
          </div>
          <!-- End Alert Info -->
