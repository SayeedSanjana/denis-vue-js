      ...
      <div class="flex items-center justify-center p-6 mx-3 my-4  ">
        ...
        <form @submit.prevent="updatePosts(this.$route.params.id)" class="w-full max-w-lg ">
          <div class="w-full lg:w-full ">
            ...
            <input class="appearance-none block w-full bg-white text-regal-teal border  border-regal-teal border-opacity-50 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:border-regal-blue" id="name" type="text" placeholder="Name" v-model="formData.name">
          </div>
          <div class="w-full lg:w-full ">
