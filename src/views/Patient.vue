        ...
        <section class="w-full  px-6 py-4 " >
            ...
            <div class="m-5 w-5/6 mx-auto flex sm:flex-row flex-col justify-between ">
                ...
                <div class="flex justify-end">
                    <button
                        class="flex items-center text-center m-2 p-1 border rounded text-white font-semibold " style="background-color:#73C6CA"
                        @click="modal">
            ...
            <table class=" border rounded-t-lg m-5 w-5/6 mx-auto bg-regal-blue " >
                <tr class="text-center border-b-2 border-gray-300 text-md text-regal-teal" >
                ...
                <tr class="border bg-white  hover:bg-gray-200  " @click="patientDetails(post._id)" 
