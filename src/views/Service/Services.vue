            ...
            <div class="flex justify-between bg-green-50">
                ...
                <div class="m-2 ">
                    <router-link :to="{name:'PatientDetails'}"
                        class="px-3 py-1 rounded-md font-semibold text-white bg-regal-teal mx-1" type="button">Back
                    </router-link>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 m-5 ">
                <section class="flex border-r">
                    ...
                    <div class=" w-1/2 text-left ">
                        <label class="  block px-3 py-1  font-bold text-sm capitalize text-left">Services
                            Provided</label>
                ...
                <section>
                    ...
                    <form @submit.prevent="saveService">
                        <div class="flex ">
                            <div class="xl:w-1/2">
                                ...
                                <div @mouseleave="tnList.length = 0">
                                    ...
                                    <ul v-else v-show="tnList.length>0"
                                        class="w-80 -mt-4 ml-5 h-44 overflow-y-scroll shadow-sm  absolute z-40 bg-regal-white border rounded-md">
                                ...
                                <div class=" relative rounded p-1 mx-4">
                                    ...
                                    <div class=" w-80 break-words h-24 section">
                                        <p class="py-3 "> <span v-if="this.tn.location.length>0 ">{{this.tn.location}}
                                            ...
                                            <span class="text-gray-400 mx-1" v-for="(i, index) in this.location"
                                                :key="index">
                                                <span> {{i}}</span>
                                ...
                                <div class="mx-5">
                                    ...
                                    <button type="button"
                                        class="px-3 py-1 rounded-md font-semibold text-white bg-regal-teal w-full"
                            ...
                            <div class="xl:w-1/2">
                                <!-- tooth svg -->
                                <ToothSvg @concatanate="concatenateLocation" @remove-comma="removeComma"
                                    :tooth="location" />
                                <!-- tooth svg -->
                            </div>
                        ...
                        <section class="ml-5">
                            ...
                            <button type="submit"
                                class="px-3 py-1 rounded-md font-semibold text-white bg-regal-teal flex items-start">Submit</button>
                        </section>
                    </form>
                    <!-- form for adding new services -->
