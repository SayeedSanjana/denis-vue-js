            ...
            <div class="container-2xl px-12 h-yyxl">
                ...
                <table class=" w-full">
                    <tr class="text-gray-900">
                        <td class="text-left ">
                            <label class="text-xs text-gray-900 font-semibold">Patient Name: <span
                                    class="text-xs font-normal text-gray-600">{{bill.patientName}}</span> </label>
                        </td>
                        <td class="text-right">
                            <label class="text-gray-900  font-semibold text-xs">Invoice Number: <span
                                    class="font-normal text-gray-600">INV-{{bill._id}}</span></label>
                        </td>
                    </tr>
                    <tr class="text-gray-900">
                        <td class="text-left">
                            <label class="text-gray-900 font-semibold text-xs">Contact Number: <span
                                    class="text-xs font-normal text-gray-600">{{bill.patientContact}}</span></label>
                        </td>
                        <td class="text-right">
                            <label class="text-gray-900 font-semibold text-xs">Invoice Date: <span
                                    class="font-normal text-gray-600">{{new Date(bill.createdAt).toLocaleDateString('en-US', {
                    year: 'numeric',
                    month: 'long',
                    day: 'numeric'
                    }) }}</span></label>
                ...
                <div class="flex justify-end py-5">
                    <div class="text-right text-gray-900 text-xs">
                        ...
                        <div class="flex justify-end">
                            <div class=" p-2 w-24"><label class="font-bold">Balance<span
                                        class="text-gray-500 font-normal">(Due) </span>:</label></div>
