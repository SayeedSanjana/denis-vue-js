            ...
            <article class="flex justify-between text-sm ">
                <div class="w-1/2 p-3 ">
                    ...
                    <div class=" text-left my-2" v-if="formData.cc.length > 0">
                        ...
                        <label class=" w-2/5 block my-2  px-3 py-1 font-bold text-sm text-regal-teal text-left">Chief
                            Complaint</label>
                    ...
                    <div  :class="{'hidebutton': previewInv , 'showbutton': !previewInv}" v-if="formData.investigation.length > 0">
                        ...
                        <ul class="  text-left  py-1 ml-6 " v-for="item in formData.investigation"
                            :key="item">
                            <li class=" list-disc ">
                ...
                <div class="w-1/2 p-3 border-l border-regal-teal border-opacity-20 mx-auto ">
                    ...
                    <section class="m-1">
                        ...
                        <div v-if="formData.medicine.length > 0" class="my-2">
                            ...
                            <ul class="ml-6 my-1 text-regal-teal">
                                <li v-for="(data,index) in formData.medicine" :key="index" class="list-disc ">
                                    ...
                                    <div class="flex justify-between">
                                        <div :class="{'strikebutton':formData.medicine[index].isHidden , 'showbutton': !formData.medicine[index].isHidden}">
                                            <div class="flex">
                                                <p class="">
                                                    {{data.category}} 
                                                    <span>
                        ...
                        <div :class="{'hidebutton': previewTreatment , 'showbutton': !previewTreatment}" v-if="formData.treatmentPlan.length > 0">
                            ...
                            <ul class=" text-left  py-1 ml-6 " v-for="item in formData.treatmentPlan"
                                :key="item">
                                <li class=" italic list-disc ">
