<template>
    ...
    <div class="bg-white w-full md:max-w-md lg:max-w-full md:mx-auto  md:w-1/2 xl:w-1/2  px-6 lg:px-16 xl:px-12 xl:ml-20
        flex  ">
    <div class="w-full">
    <div >
                ...
                <div>
                    ...
                    <div class="flex justify-center -mx-3 border-b border-gray-300 ">
                         <div class="w-full mb-8"> 
                            <button class="block w-64 max-w-xs mx-auto text-white rounded-lg  py-3 font-semibold " style="background:#46CDD3" @click="submitForm" >Login</button>
                        </div>
                    </div> 
                      <p v-if="!formIsValid" class="text-red-500 mb-4 text-center">{{this.str}}</p>
                        <div class="flex justify-center -mx-3 mt-8">
                            <div class="w-full mb-4"> 
                                <h3 class="text-md mb-2" style="color:#036792">Don't Have An Account?</h3>
                            <router-link to="/register" class="block w-64 max-w-xs mx-auto text-white rounded-lg  py-3 font-semibold" style="background:#036792">Create New Account</router-link>
                            </div>
...
<!-- <div class="min-w-screen min-h-screen  flex items-center justify-center px-4 py-4">
                ...
                <div>
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-12">
                            ...
                            <div class="flex">
                                ...
                                <input v-model.trim="formData.password" type="password" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************">
                            </div>
                        </div>
                    </div>
                    <p v-if="!formIsValid" class="text-red-500 mb-4 text-center">Please enter a valid email and password</p>
                    <div class="flex -mx-3">
                    ...
                    <hr />
                        <div class="w-full px-3 mb-5 mt-4">
                            <router-link to="/register" class="block w-full max-w-xs mx-auto bg-gray-500 hover:bg-gray-600 focus:bg-gray-600 text-white rounded-lg px-3 py-3 font-semibold text-center">Create New Account</router-link>
                        </div>
                </div>
                </form>
                 <div v-if="this.err">
                        <p  class="text-red-500 mb-4 text-center">Please enter the right credentials</p>
                 </div>
            </div>
        </div>
    </div>
