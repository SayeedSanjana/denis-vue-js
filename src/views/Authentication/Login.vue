                                    ...
                                    <div class="w-full  mb-5 text-left">
                                        ...
                                        <div class="flex">
                                            <div
                                                class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                                <i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                            <input v-model="formData.password" type="password" @blur="v$.formData.password.$touch()"  @keydown="toggle()" class="w-full h-12 -ml-10 pl-4 pr-3 py-2 rounded outline-none text-regal-teal" style="background:#E7FBFC">
                                        </div>
