                    ...
                    <div class="flex -mx-3">
                        <div class="w-1/2 px-3 mb-5">
                            ...
                            <div class="flex">
                                ...
                                <input v-model.trim="formData.name" type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John">
                            </div>
                        </div>
