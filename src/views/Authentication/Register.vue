              ...
              <div>
                  ...
                  <div class="w-full  mb-3 text-left ">
                    ...
                    <div class="flex">
                      ...
                      <input v-model.trim="formData.name" type="text"
                        class="w-full -ml-10 h-11 pl-10 rounded outline-none text-regal-teal"
                ...
                <div class="flex 2xl:-mr-12 -mx-1">
                  ...
                  <div class="w-1/2 mr-3 mb-3 text-left">
                    ...
                    <div class="relative">
                      <select
                        class="block appearance-none w-full  text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white"
                        style="background:#E7FBFC" id="gender" v-model="formData.gender">
                        <option>Male</option>
                  ...
                  <div class="w-1/2  mb-3 text-left">
                    ...
                    <div class="">
                      ...
                      <input
                        class="appearance-none block w-full rounded py-3 px-4 leading-tight focus:outline-none  pl-10 text-regal-teal"
                        style="background:#E7FBFC" id="date" type="date" placeholder="" v-model="formData.dob">
                    </div>
                ...
                <div class="flex 2xl:-mr-12 -mx-1">
                  <div class="w-full mb-3 text-left">
                    ...
                    <div class="flex ">
                      <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i
                          class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                      <textarea v-model.trim="formData.address" type="text"
                        class="w-full -ml-10 pl-10 pr-3 py-2 text-regal-teal   rounded h-24 outline-none "
                        style="background:#E7FBFC"></textarea>
                    </div>
                ...
                <div class="flex 2xl:-mr-12 -mx-1">
                  <div class="w-full  mb-2 text-left">
                    <label for="" class="text-sm font-medium px-1  text-regal-teal">Phone <span
                        class="text-xs text-gray-400 font-medium">(Should include only digits i.e 0-9)</span></label>
                    <div class="flex">
                      <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i
                          class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                      <input v-model.trim="formData.phone" type="text"
                        class="w-full -ml-10 h-11 py-2 pl-10 rounded outline-none text-regal-teal"
                        style="background:#E7FBFC">
                    </div>
                  ...
                  <div class="w-full  mb-2 text-left">
                    ...
                    <div class="flex">
                      ...
                      <input v-model.trim="formData.email" type="email"
                        class="w-full -ml-10 h-11 py-2  pl-10 text-regal-teal rounded outline-none"
                        style="background:#E7FBFC">
                    </div>
                ...
                <div class="flex 2xl:-mr-12 -mx-1">
                  <div class="w-full  mb-2 text-left">
                    <label for="" class="text-sm font-medium px-1  text-regal-teal">Password <span
                        class="text-xs text-gray-400 font-medium">(Should include 0-9,A-Z, a-z and special
