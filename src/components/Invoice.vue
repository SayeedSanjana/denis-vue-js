    ...
    <div class="w-full  lg:max-w-3xl max-w-lg  max-h-screen overflow-y-scroll p-6 relative mx-auto my-auto rounded-xl shadow-lg  bg-white">
      ...
      <div class="mt-5">
        ...
        <div class="px-0  flex items-start">
           <span class="text-gray-600 ">Date</span><span class="text-gray-400 ml-1">{{this.date}}</span>
        </div>
        <div class="px-0 flex items-start" >
           <span class="text-gray-600">Patient Name: </span><span class="text-indigo-500 text-lg ml-1">{{this.patientData.name}}</span>
        </div>
         <div class="px-0 flex items-start" >
           <span class="text-gray-600">Contact: </span><span class="text-indigo-500 text-lg ml-1">{{this.patientData.phone}}</span>
        </div>
        </div>

        <div class="">
            <div class="px-0 flex items-end" >
           <span class="text-gray-600">Invoice No # </span><span class="text-indigo-600 text-lg ml-1">{{this.Bills._id.substring(this.Bills._id.length - 7)}}</span>
        </div>
        </div>
