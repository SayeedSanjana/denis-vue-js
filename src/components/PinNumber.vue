 ...
 <div class=" inset-0 w-full flex  items-center justify-center"> 
    <div class="bg-white rounded-lg  p-4">
        ...
        <div class="flex justify-between">
            <div class="flex"> 
            <input v-model="pinno" class=" border mx-2 rounded-lg flex items-center text-center font-thin text-3xl test" maxlength="4" max="4" min="0" inputmode="decimal" type="password" >
         ...
         <div class="ml-3">
          <button @click="validate" class="p-3 bg-regal-teal text-center border text-white font-semibold  rounded-md text-xs flex">
                    Submit
          </button>
          </div>
         </div>
